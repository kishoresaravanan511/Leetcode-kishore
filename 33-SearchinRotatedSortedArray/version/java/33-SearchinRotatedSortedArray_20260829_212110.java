// Last updated: 8/29/2026, 9:21:10 PM
1// class Solution {
...
60
61
62//standard binary search solution..
63class Solution {
64    public int[] searchRange(int[] nums, int target) {
65        int start = firstOccurence(nums,0,nums.length-1,target);
66        if(start == -1)     return new int[]{-1,-1};   //very very important when it comes to time complexity,it eliminates the search space.
